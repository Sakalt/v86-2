...
function KeyboardAdapter()
{
    ...
    this.init = function(code_fn)
    {
        ...
        document.body.addEventListener("keyup", keyup_handler, false);
        document.body.addEventListener("keydown", keydown_handler, false);
        document.body.addEventListener("blur", blur_handler, false);
    };

    this.destroy = function() 
    {
        document.body.removeEventListener("keyup", keyup_handler, false);
        document.body.removeEventListener("keydown", keydown_handler, false);
        document.body.removeEventListener("blur", blur_handler, false);
    };
